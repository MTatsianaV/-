...
PrintArray(arr);
int sumNegativElem = GetSumNegativElem(arr);
int sumPositivElem = GetSumPositivElem(arr);
Console.WriteLine($"Сумма положительных элементов равна: {sumPositivElem}, сумма отрицательных элементов равна: {sumNegativElem}");
